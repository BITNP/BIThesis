%%
% 北京理工大学毕业设计演示文稿模板 —— 使用 XeLaTeX 编译 The BIThesis Template for Presentation
...
\begin{frame}[t] % 第一页
  ...
  % 关于 `\CJKunderline{}` `\CJKunderline*{}` 等更多用法，请参见 https://mirrors.ibiblio.org/CTAN/macros/xetex/latex/xecjk/xeCJK.pdf 的 xeCJKfntef 用法说明 一节
