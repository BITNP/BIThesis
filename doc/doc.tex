...
% create solid round numbers
% \newcommand*\circled[1]{\tikz[baseline=(char.base)]{
%             \node[shape=circle,fill,scale=0.4] (char) {\textcolor{white}{#1}};}}
...
\date{\zihao{-4} \today\quad \color{RubineRed}{\kaishu 版本 \version}}
\maketitle
...
\begin{abstract}
  ...
  {\BIThesis} 北京理工大学本科生 {\LaTeX} 模板目前支持使用 {\hologo{XeLaTeX}} 进行编译，使用以 biber 为后端的 BibLaTeX 进行参考文献的生成，符合《信息与文献参考文献著录规则》（\href{http://openstd.samr.gov.cn/bzgk/gb/newGbInfo?hcno=7FA63E9BBA56E60471AEDAEBDE44B14C}{GB/T 7714—2015}）的标准。目前主要实现了计算机学院本科生毕业论文开题报告、毕业设计毕业论文与通用实验报告的模板。
\end{abstract}
...
\input{chapters/4-graduation-thesis.tex}
\input{chapters/5-lab-report.tex}
\input{chapters/6-converting-to-word.tex}
\input{chapters/7-acknowledgements.tex}
